...
IGNORE_EXT = ('cab', 'ico', 'swf', 'rar', 'zip', 'tar', 'gz', '7z', 'bz2', 'iso', 'nrg', 'uif', 'exe', 'rpm', 'deb', 'dmg', 'jar', 'jad',
        'bin', 'apk', 'run', 'msi', 'xls', 'xlsx', 'ppt', 'pptx', 'pdf', 'doc', 'docx', 'odf','txt', 'rtf', 'odt', 'mkv', 'avi', 'mp4',
         'flv', 'WebM', 'mov', 'wmv', '3gp', 'mpg', 'mpeg', 'mp3', 'wav', 'ogg', 'mp4a', 'wma', 'png', 'jpeg', 'jpg', 'xpm', 'gif', 'tiff',
          'js', 'css', 'bmp', 'svg', 'exif', 'thmx', 'xml')
'''
不期待文件后缀
'''
...
START_URLS = '/Users/snaker/tools/tangscancode/mspiderv2/data/starturls.txt'
'''
爬虫起始urls
'''
